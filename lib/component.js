...
/*****************************************************************************/
/**
 * Overrides Blaze.View lookup method to also look for component methods.
 */
var lookup = Blaze.View.prototype.lookup;
Blaze.View.prototype.lookup = function (name, _options) {
  // we need to get the current view which might be lower
  // in the rendered view heirarchy than this view. The reason
  // is so that we can support templates like this:
  //
  // <template name="Outer">
  //   {{#StripeForm}}
  //    {{> errors}}
  ...
  // </template>
  //
  // The StripeForm component will never show up in the chain if we don't
  // use Blaze.getView() since "this" is actually Outer.
  var component = findFirstComponent(Blaze.getView());
...
Component.lookup = function (view, prop) {
  ...
  if (Package['iron:controller']) {
    return Blaze._withCurrentView(origView, function () {
